...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public final String chinaDrmLine;
    ...
    public HlsMediaPlaylist(@PlaylistType int playlistType, String baseUri, List<String> tags,
                            ...
                            Segment initializationSegment, List<Segment> segments, String line) {
        super(baseUri, tags);
    ...
    public HlsMediaPlaylist copyWith(long startTimeUs, int discontinuitySequence) {
        return new HlsMediaPlaylist(playlistType, baseUri, tags, startOffsetUs, startTimeUs, true,
                ...
                hasEndTag, hasProgramDateTime, initializationSegment, segments, chinaDrmLine);
    }
    ...
    public HlsMediaPlaylist copyWithEndTag() {
        ...
        return new HlsMediaPlaylist(playlistType, baseUri, tags, startOffsetUs, startTimeUs,
                ...
                hasIndependentSegmentsTag, true, hasProgramDateTime, initializationSegment, segments,chinaDrmLine);
    }
