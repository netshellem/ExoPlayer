 ...
 */
@TargetApi(16)
public class IrdetoMediaCodecVideoRenderer extends MediaCodecRenderer {

    private static final String TAG = "IrdetoVideoRenderer";
     ...
     */
    public IrdetoMediaCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector) {
